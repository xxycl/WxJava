...
public class WxCpDocSmartSheetAddRecordData implements Serializable {
  ...
  public static WxCpDocSmartSheetAddRecordData fromJson(String json) {
    return WxCpGsonBuilder.create().fromJson(json, WxCpDocSmartSheetAddRecordData.class);
  }
